...
EXAMPLE_DIR="${EXAMPLE_DIR:-/tmp/vllm-omni-dependency/lingbot-world/examples/00}"
INPUT_IMAGE="${INPUT_IMAGE:-${EXAMPLE_DIR}/image.jpg}"
PROMPT="${PROMPT:-$(cat "${EXAMPLE_DIR}/prompt.txt")}"
OUTPUT_PATH="${OUTPUT_PATH:-lingbot_world_output.mp4}"
